...
public class CommClient
{
	...
	public void go_sctp(int node_id, String node_name, int node_port, Packet pktObj)
	{
		...
		try
		{
			...
			*/
			...
			byteBuffer.put(AOSProject2.serialize(pktObj));
		...
		{
			AOSProject2.write_output("111 - Node:"+AOSProject2.local_node_id+" -- "+pktObj.packet_type+" : From "+pktObj.sender_id+" To "+pktObj.receiver_node_id,true);
			ex.printStackTrace();
		}
	}
	...
	{
		AOSProject2.write_output("Node:"+AOSProject2.local_node_id+" Sent -- "+pktObj.packet_type+" : From "+pktObj.sender_id+" To "+pktObj.receiver_node_id,true);
	...
	*/
	...
	public void go_tcp(int node_id, String node_name, int node_port, Packet pktObj)
	{
		...
		try
		{
			...
			Socket clientSocket = new Socket(node_name,node_port);
